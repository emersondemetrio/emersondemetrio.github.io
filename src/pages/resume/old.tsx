...
const SectionViewer: React.FC<{ section: Section }> = ({ section }) => (
  <div className="SectionViewer">
    ...
    {section.fields.map((field) => <SectionFieldViewer key={field.key} field={field} />)}
    {section.records.map((record) => <RecordViewer key={record.key} record={record} />)}
  </div>
);
    ...
    <div className="ResumeViewer flex">
      ...
      <div className="flex row">
        <div className="flex column">
          {content.sections.map((section) => <SectionViewer key={section.key} section={section} />)}
        </div>
